...
WebUI.setText(findTestObject('Object Repository/IOC/input_Lc_Keyword'), 'sự kiện 03')

WebUI.click(findTestObject('Object Repository/IOC/Page_Trung tm qun l iu hnh/button_Tm kim'))

WebUI.verifyTextPresent('sự kiện 03', false)
