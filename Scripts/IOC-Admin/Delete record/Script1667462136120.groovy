...
WebUI.click(findTestObject('Object Repository/i_Hin th_fas fa-trash-alt delete'))

WebUI.click(findTestObject('Object Repository/IOC/Page_Trung tm qun l iu hnh/button_Xa'))

WebUI.verifyTextPresent('Xoá thành công!', false)
