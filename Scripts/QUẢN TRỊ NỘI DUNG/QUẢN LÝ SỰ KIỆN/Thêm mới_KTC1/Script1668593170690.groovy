...
WebUI.setText(findTestObject('1.QTND/1.3 QLSK/txtb_ten_sk'), 'Sự kiện ngày mới')

WebUI.verifyElementNotClickable(findTestObject('1.QTND/1.3 QLSK/btn_Luu_Them moi'))
