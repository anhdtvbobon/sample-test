...
WebUI.click(findTestObject('1.QTND/1.4 QLHDSD/btn_themmoi_HDSD'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('1.QTND/1.4 QLHDSD/txtb_ nhaptendhdsd'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('1.QTND/1.4 QLHDSD/txtb_Mota'), FailureHandling.STOP_ON_FAILURE)
