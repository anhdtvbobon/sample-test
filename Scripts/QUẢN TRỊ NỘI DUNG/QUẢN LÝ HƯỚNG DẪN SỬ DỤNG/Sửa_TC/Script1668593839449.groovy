...
WebUI.setText(findTestObject('1.QTND/1.4 QLHDSD/txtb_Nhap_ten_HDSD'), 'HDSD hệ thống dữ liệu thống kê 2')

WebUI.click(findTestObject('1.QTND/1.4 QLHDSD/btn_Luu_Edit'))

WebUI.verifyTextPresent('HDSD hệ thống dữ liệu thống kê 2', false)
