...
WebUI.setText(findTestObject('1.QTND/1.4 QLHDSD/txtb_ nhaptendhdsd'), 'HDSD Tủ lưu trữ công văn')

WebUI.click(findTestObject('1.QTND/1.4 QLHDSD/btn_search_HDSH'))

WebUI.verifyTextPresent('HDSD Tủ lưu trữ công văn', false)
