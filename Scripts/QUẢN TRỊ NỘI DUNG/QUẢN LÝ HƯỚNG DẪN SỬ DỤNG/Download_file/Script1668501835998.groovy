...
WebUI.click(findTestObject('1.QTND/1.2QLMN/btn_Themmoi'))

WebUI.setText(findTestObject('1.QTND/1.2QLMN/txtb_Nhap_ten_menu'), 'Trang chủ')

WebUI.click(findTestObject('1.QTND/1.2QLMN/drd_Duong_dan'))

WebUI.click(findTestObject('1.QTND/1.2QLMN/spam_QTND'))
