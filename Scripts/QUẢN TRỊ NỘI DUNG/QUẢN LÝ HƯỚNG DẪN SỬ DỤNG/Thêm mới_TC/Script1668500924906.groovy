...
WebUI.click(findTestObject('1.QTND/1.4 QLHDSD/btn_themmoi_HDSD'))

WebUI.setText(findTestObject('1.QTND/1.4 QLHDSD/txtb_NhaptenHDSD'), 'Hướng dẫn đọc tài liệu')

WebUI.setText(findTestObject('1.QTND/1.4 QLHDSD/txtb_Mota'), 'Cách đọc tài liệu')

WebUI.click(findTestObject('1.QTND/1.4 QLHDSD/btn_taifile'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('1.QTND/1.4 QLHDSD/btn_lưu_themmoi'))
