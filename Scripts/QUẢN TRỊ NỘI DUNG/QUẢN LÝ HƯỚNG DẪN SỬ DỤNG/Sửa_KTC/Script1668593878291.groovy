...
WebUI.click(findTestObject('1.QTND/1.4 QLHDSD/btn_Edit_HDSD'))

WebUI.clearText(findTestObject('1.QTND/1.4 QLHDSD/txtb_Nhap_ten_HDSD'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('1.QTND/1.4 QLHDSD/txtb_Mota'), 'Kho dữ liệu nhân sự 1')

WebUI.verifyElementNotClickable(findTestObject('1.QTND/1.4 QLHDSD/btn_Luu_Edit'))
