...
WebUI.click(findTestObject('1.QTND/1.2QLMN/drd_ứng dụng'))

WebUI.click(findTestObject('1.QTND/1.2QLMN/li_Portal'))
...
WebUI.setText(findTestObject('1.QTND/1.2QLMN/txtb_Nhap_ten_menu'), 'Trang chủ')

WebUI.click(findTestObject('1.QTND/1.2QLMN/btn_Luu'))

WebUI.verifyTextPresent('Thêm mới thất bại', false)
