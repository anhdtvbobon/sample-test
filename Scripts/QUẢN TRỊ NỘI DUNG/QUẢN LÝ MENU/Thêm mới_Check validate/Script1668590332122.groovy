...
WebUI.setText(findTestObject('1.QTND/1.2QLMN/txtb_Nhap_ten_menu'), 'sdsdffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff')

WebUI.verifyTextPresent('Tiêu đề tối đa 50 ký tự', false)
