...
WebUI.setText(findTestObject('1.QTND/1.3 QLSK/txtb_Nhaptensukien'), 'Sự kiện khai trương mới')

WebUI.click(findTestObject('1.QTND/1.3 QLSK/btn_search'))

WebUI.verifyTextPresent('Sự kiện khai trương mới', false)
