...
WebUI.click(findTestObject('1.QTND/1.3 QLSK/btn_themmoi_sk'))

WebUI.setText(findTestObject('1.QTND/1.3 QLSK/txtb_ten_sk'), 'Sự kiện mới ngày thứ 2')

WebUI.setText(findTestObject('1.QTND/1.3 QLSK/txtb_Mo_ta'), 'Quốc khánh 2/9')

WebUI.clickImage(findTestObject('1.QTND/1.3 QLSK/immage_calendar'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('1.QTND/1.3 QLSK/span_15'))

WebUI.click(findTestObject('1.QTND/1.3 QLSK/btn_Luu_Them moi'))
