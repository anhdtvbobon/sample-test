...
WebUI.setText(findTestObject('1.QTND/1.3 QLSK/txtb_Tensukien'), 'Sự kiện khai trương cửa hàng mới')

WebUI.click(findTestObject('1.QTND/1.3 QLSK/btn_Luu_Edit'))

WebUI.verifyTextPresent('Sự kiện khai trương cửa hàng mới', false)
