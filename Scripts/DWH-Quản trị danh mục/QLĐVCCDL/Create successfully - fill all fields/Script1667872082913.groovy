...
WebUI.setText(findTestObject('Object Repository/Input/input_M n v_code'), 'Dương Văn Túc')

WebUI.setText(findTestObject('input_Tn n v_name'), 'Tuc DV')

WebUI.setText(findTestObject('textarea_M t_description'), 'Dương văn Túc mã đơn vị không được trùng')
