...
WebUI.setText(findTestObject('Object Repository/Input/input_M n v_code'), 'Đặng Thị Vân anh')

WebUI.setText(findTestObject('Object Repository/input_Tn n v_name'), 'Đặng Thị Vân anh')

WebUI.setText(findTestObject('Object Repository/textarea_M t_description'), 'Đặng Thị Vân anh')

WebUI.click(findTestObject('Object Repository/button_Lu'))

WebUI.closeBrowser()

WebUI.verifyTextPresent('Đơn vị cung cấp đã tồn tại!', false)
