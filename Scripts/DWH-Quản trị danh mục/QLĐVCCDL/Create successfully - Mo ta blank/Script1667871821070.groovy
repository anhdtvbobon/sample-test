...
WebUI.setText(findTestObject('Object Repository/Input/input_M n v_code'), 'vân anh vân anh ')

WebUI.setText(findTestObject('input_Tn n v_name'), 'vân anh 0001')

WebUI.setText(findTestObject('textarea_M t_description'), '')

WebUI.click(findTestObject('button_Lu'))
