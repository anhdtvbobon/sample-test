...
WebUI.click(findTestObject('2. QTHT/2.3 QLHSCB/mnu_HSCB'))

WebUI.click(findTestObject('2. QTHT/2.3 QLHSCB/btn_xóa'))

WebUI.click(findTestObject('2. QTHT/2.3 QLHSCB/btn_xác nhận xóa'))
