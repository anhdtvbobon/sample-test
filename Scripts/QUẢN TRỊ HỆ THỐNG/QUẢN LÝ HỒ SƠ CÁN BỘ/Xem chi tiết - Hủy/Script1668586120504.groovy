...
WebUI.click(findTestObject('2. QTHT/2.2 QLHSCB/btn_chi tiết'))

WebUI.click(findTestObject('2. QTHT/2.2 QLHSCB/btn_hủy chi tiết'), FailureHandling.STOP_ON_FAILURE)
