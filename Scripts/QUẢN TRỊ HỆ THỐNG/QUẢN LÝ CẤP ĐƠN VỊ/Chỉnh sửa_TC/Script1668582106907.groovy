...
WebUI.click(findTestObject('2. QTHT/2.2 QLCĐV/btn_sửa'))

WebUI.setText(findTestObject('2. QTHT/2.2 QLCĐV/txtb_tên_cấp_đơn_vị'), 'Test 122')

WebUI.click(findTestObject('2. QTHT/2.2 QLCĐV/btn_lưu_sửa'))
