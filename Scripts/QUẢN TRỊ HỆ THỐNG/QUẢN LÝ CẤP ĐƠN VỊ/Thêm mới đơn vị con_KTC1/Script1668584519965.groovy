...
WebUI.click(findTestObject('2. QTHT/2.2 QLCĐV/btn_thêm_mới_con'))

WebUI.delay(5)

WebUI.setText(findTestObject('2. QTHT/2.2 QLCĐV/txtb_Mô tả'), 'thêm Test con 1.1')

WebUI.verifyElementNotClickable(findTestObject('2. QTHT/2.2 QLCĐV/btn_lưu_con'))
