...
WebUI.click(findTestObject('1.QTND/1.1 PQMN/btnChonNND'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('1.QTND/1.1 PQMN/div_Chn nhm ngi dng'))

WebUI.click(findTestObject('1.QTND/1.1 PQMN/cbx_ALL_phân quyền'))

WebUI.click(findTestObject('1.QTND/1.1 PQMN/div_Chn nhm ngi dng'))

WebUI.click(findTestObject('1.QTND/1.1 PQMN/btnLưu'))

WebUI.verifyTextPresent('ThuKy', false)

WebUI.verifyTextPresent('Phân quyền chức năng thành công!', false)
