...
WebUI.click(findTestObject('1.QTND/1.2QLMN/btnEdit'))

WebUI.setText(findTestObject('1.QTND/1.2QLMN/txtbMota'), 'Cấu hình SSO 1')

WebUI.click(findTestObject('1.QTND/1.2QLMN/btn_Luu'))

WebUI.verifyTextPresent('Cấu hình SSO 1', false)
